...
export const LINEUP_TEAM: readonly LineupTeamCard[] = [
  ...
  {
    id: "greeys",
    name: "Greeys Redrován · Jefe de Agencia",
  ...
  {
    id: "cristina",
    name: "Cristina Campoverde · Creadora de Contenido",
    imageSrc: `${PERSONAL}/Diseno-sin-titulo-1.png`,
    imageSrcSet: "",
    imageWidth: 2000,
    imageHeight: 3000,
    sizes: "(max-width: 900px) 100vw, 33vw",
  ...
  {
    id: "emily",
    name: "Emily Araujo · Community Manager",
    imageSrc: `${PERSONAL}/Diseeno-sin-titulo.png`,
    imageSrcSet: "",
    imageWidth: 2000,
    imageHeight: 3000,
    sizes: "(max-width: 900px) 100vw, 33vw",
  ...
  {
    id: "dario",
    name: "Darío Arévalo · Diseñador Gráfico",
    imageSrc: `${PERSONAL}/DARIO.png`,
    imageSrcSet: "",
    imageWidth: 2000,
    imageHeight: 3000,
    sizes: "(max-width: 900px) 100vw, 33vw",
